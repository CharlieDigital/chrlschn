...
If you play around with this example in the **Result** view, you'll see that when you toggle the `SWITCH` and `MUSIC!`, buttons, the different parts of the component tree render independently.
